...
<template>
  <div class="flex sm:flex-row items-center justify-between gap-4 sm:gap-0">
    <p class="title-text text-center sm:text-left">{{ $t(`pages.${router.currentRoute.value.name}`) }}</p>
